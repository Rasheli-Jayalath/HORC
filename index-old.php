                    ...
                    <div class="row">
                      <div class="col-sm-12" style="height:90px">
                        ...
                        <div>
                          ...
                          <div class="d-none d-md-block">
                            <p class="statistics-title" style="color:#006"><strong>Last Payment(This Month)</strong></p>
                            <h3 class="rate-percentage"><?php echo $this_amount_million. " M";?></h3>
                            <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span></span></p>
                          </div>
                          <div class="d-none d-md-block">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
							 ...
							 $objSDb->dbQuery($swwSQL);
							  ...
							  {
							 $nos_id= $iss_rows['nos_id'];
							   ?>
                                        <li class="d-block">
                                          <div class="form-check w-100">
                                            <label class="form-check-label">
                                             <a style="text-decoration:none; color:black" href="pages/project-tools/project_issues/issue_detail.php?nos_id=<?php echo  $nos_id ?>"> <?php echo trim($iss_rows['iss_title']);?></a><i class="input-helper rounded"></i>
                                            </label>
                                            <div class="d-flex mt-2">
                                              <div class="ps-4 text-small me-3"> <?php  if($iss_rows['iss_date']=='0000-00-00')
											  {
											  }
											  else
											  {
												 echo date('d, F, Y',strtotime($iss_rows['iss_date']));
											  }?></div>
