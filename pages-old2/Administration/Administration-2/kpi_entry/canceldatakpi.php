...
<table  width="100%" >
		  ...
		  <div id="activities"  <?php echo $style; ?>> 
			...
			{
			$kpiidd=$row3g['itemid'];
			$sqlw="SELECT a.itemid FROM kpi_activity a inner join activity b on (a.itemid=b.itemid) where b.itemid=".$kpiidd. " AND b.temp_id=".$temp_id. " and a.kpiid=".$itemid;
			   ...
			   <?php  if($kpientry_flag==1 || $kpiadm_flag==1)
				...
				?>
                   ...
                   <tr>
                    ...
                    <?php 
/* */
 $sql_b="SELECT a.kaid, b.aid,b.itemid,b.startdate,b.enddate, b.baseline, b.rid FROM kpi_activity a inner join activity b on (a.itemid=b.itemid) where a.kpiid=".$itemid ." AND b.temp_id=$temp_id"; 
