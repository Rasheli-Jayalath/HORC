            ...
            <div class="card bg-form">
                ...
                <hr>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
  <h5 style="text-align:center"><?php echo  $trail; ?></h5>
  <h5 style="text-align:center"><?php  if($err_msg!="")
		   ...
		   {?>
            ...
            <input id="txtparentcd" name="txtparentcd" type="hidden" value="<?php echo $parentcd; ?>" readonly=""/>
                         ...
                         <input class="form-control form-control-enhanced"  id="txtitemcode" name="txtitemcode" type="text" value="<?php echo $itemcode; ?>" required placeholder="Enter Code">
                      ...
                      <input  required  class="form-control form-control-enhanced" id="txtitemname" name="txtitemname" type="text" value="<?php echo $itemname; ?>" placeholder="Enter Name">
                     ...
                     <select  style="font-size: 14px; color: #000;background-color: #fff;" onchange="" class="form-control" name="txtisentry" >
    ...
    <div class=" grid-margin stretch-card " style = "margin-top: 3%;">
              <div class="card" style="background-image: linear-gradient(180deg, #fff, #c9c9f5);">
                <div class="card-body text-center">
                  <h4 class="card-title">Add  BOQ</h4>

                  <form class="forms-sample" name="frmresources" id="frmresources" action=""  method="post" onsubmit="" enctype="multipart/form-data">
                   <div class="form-group row">
                    <div class="text-center col-sm-13">
                    <?php echo  $trail; ?>
                    </div>
                    </div>
                    <div class="form-group row">
		   ...
		   {?>
            ...
            <input id="txtparentcd" name="txtparentcd" type="hidden" value="<?php echo $parentcd; ?>" readonly=""/>
                      ...
                      <div class="text-center col-sm-4">
                      <label for="exampleSelectGender" style="font-weight: bold;margin-top:25px"><?php if(isset($milestone)&&$milestone==1)
										 { 
										 echo SUB_MIL_CODE;
										 } else
										 {
                         ...
                         <input class="form-control text-center "  id="txtitemcode" name="txtitemcode" type="text" value="<?php echo $itemcode; ?>">
                    ...
                    <div class="text-center col-sm-4">
                      ...
                      <div class="text-center col-sm-4">
                      <label for="exampleSelectGender" style="font-weight: bold;margin-top:15px"><?php if(isset($milestone)&&$milestone==1)
										 { 
										 echo SUB_MIL_NAME;
										 } else
										 {
                      ...
                      <input  class="form-control text-center "  id="txtitemname" name="txtitemname" type="text" value="<?php echo $itemname; ?>">
                      </div>
                    ...
                    <div class="text-center col-sm-4">
                      ...
                      <div class="text-center col-sm-4">
                      <label for="exampleSelectGender" style="font-weight: bold;margin-top:15px"><?php echo IS_ENTRY;?>: </label>
                     <select  style="font-size: 14px; color: #000;background-color: #fff;" onchange="" class="form-control" name="txtisentry" >
                        <option value="0"  <?php if($isentry==0){?>selected="selected"<?php }?>  ><?php echo NO;?></option>
			 			<option value="1" <?php if($isentry==1){?>selected="selected"<?php }?> ><?php echo YES;?></option>
  </select>
    ...
    <input type="submit" value="Update" name="update"   class="btn btn-primary me-2"/>
	 ...
	 {
	 ?>
     <input type="submit"  class="btn btn-primary me-2" value="<?php echo SAVE;?>" name="save" id="save" />
