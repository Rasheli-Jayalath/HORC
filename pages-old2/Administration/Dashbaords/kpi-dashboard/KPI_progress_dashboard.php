...
?>
 <?php
//========================================================
$end_time = microtime(true); //checker
$execution_time = ($end_time - $start_time); // checker
//
//echo "<h1 style='color:#F00'>"."SPEED TEST - Execution time of script = ".$execution_time." sec"."</h1>"; // checker
//=========================================================
?>
