...
$sqres=$objDb -> dbQuery($squ);
$sqrows=$objDb -> dbFetchArray();
...
*/			$resg=$objDb -> dbQuery($sqlg);
			...
			$sqlw="SELECT a.itemid FROM kpi_activity a inner join activity b on (a.itemid=b.itemid) where b.itemid=".$itemidd. " and a.kpiid=".$kpiid;
...
<?php 
$sql_b="SELECT a.kaid, b.aid,b.itemid,b.startdate,b.enddate, b.baseline, b.temp_id, b.rid FROM `kpi_activity` a inner join activity b on (a.itemid=b.itemid) where a.kpiid=".$kpiid; 
...
<table  width="100%" >
		  ...
		  <div id="activities"  <?php echo $style; ?>> 
			...
			{
			$itemidd=$row3g['itemid'];
			$sqlw="SELECT a.itemid FROM kpi_activity a inner join activity b on (a.itemid=b.aid) where b.itemid=".$itemidd;
			$sql_resw=$objDb -> dbQuery($sqlw);
...
<?php 
$sql_b="SELECT a.kaid, b.aid,b.itemid,b.startdate,b.enddate, b.baseline, b.temp_id, b.rid FROM `kpi_activity` a inner join activity b on (a.itemid=b.aid) where a.kpiid=".$kpiid; 
/*$sql_d="Select * from kpi_activity where milestoneid=$itemid";*/
			$res_b=$objDb2 -> dbQuery($sql_b);
			$i=1;
			while($row3_b=$objDb2 -> dbFetchArray())
