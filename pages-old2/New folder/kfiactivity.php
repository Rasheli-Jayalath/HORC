  ...
  if($comp!=""){
    ...
    if($location!=""){
      ...
      $query2=$location;
                          ...
                          $pdSQLcn = "SELECT SUM(boqqty*boq_cur_1_rate) AS total FROM boq a left join boqdata b on (a.itemid=b.itemid) WHERE b.parentcd =$itemid order by a.boqcode";
          ...
          <div class="row">
           ...
           <table class="table table-striped">
                             ...
                             foreach($parentgroup as $parentcd){
                                    ...
                                    $i=0;
                                  $pdSQLcn7 = "SELECT * FROM `calc_value` where boqcode='".$itemcode."' and parentcd=".$parentcd." order by parentcd";
                              ...
                              <tbody>
                                ...
                                $supp_group=array();
                                  ...
                                  foreach($supp_group as $supp){
                                    ...
                                    $sql2 = "SELECT sum(amount) as total FROM calc_value a left join boqdata b on (a.itemid=b.itemid) WHERE b.parentgroup like '%".$supp."%';
                                    ";
                                    $objDb->dbQuery($sql2);
                                  ...
                                  $err_group=array();
                                    ...
                                    $sql3="SELECT parentgroup FROM `boqdata` where itemcode = 'ERECTION'";
                                    $objDb->dbQuery($sql3);
                                    while($suppcount =$objDb->dbFetchArray())
                                    {
                                    ...
                                    foreach($err_group as $err){
                                      ...
                                      $sql4 = "SELECT sum(amount) as total FROM calc_value a left join boqdata b on (a.itemid=b.itemid) WHERE b.parentgroup like '%".$err."%'";
                                      $objDb->dbQuery($sql4);
                                      while($supp_total_c =$objDb->dbFetchArray())
                                      {
                                ...
                                $k=0;
                                  ...
                                  <tr>
                                   ...
                                   <?php } ?>
                                    ...
                                    <?php if($supp_total[$k]>0 && $amount>0){?>
                                    <td ><?php echo round(($calc1*0.00)*100,3)."%";?></td>
                                   <?php } ?>
                                   ...
                                   <?php } ?>
                                    ...
                                    <tr>
                                    <td style="font-weight: bold;"><?php echo"Total Weight Substation:";?></td>
                                   ...
                                   <?php } ?>
                                    ...
                                    <tr>
                                    <td style="font-weight: bold;"><?php echo"Implementation Progress Substation:";?></td>
                                   ...
                                   <?php } ?>
                                    ...
                                    <tr>
                                    <td style="font-weight: bold;"><?php echo"% Completed Substation:";?></td>
