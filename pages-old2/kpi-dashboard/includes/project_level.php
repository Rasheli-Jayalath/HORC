...
$ptodate=0;
$ptolast=0;
$levelcount=$_REQUEST['level_count'];

 $reportquery ="SELECT * FROM kpidata where parentgroup LIKE '".$parentgroup."%'  ";
if($levelcount!=0)
{
$reportquery .=" AND activitylevel=".$levelcount;
}
$reportquery .=" order by kpiid,itemcode ";
$i=0;
$progress=0;
$pcurrent=0;
$pprev=0;
