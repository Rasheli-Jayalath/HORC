...
rfi_activity_location_from, rfi_activity_location_to, rfi_contractor_rep_name, RFI_Received_by, RFI_Received_date_time, RFI_Scanned_document)
 ...
 '$rfi_activity_location_from','$rfi_activity_location_to','$rfi_contractor_rep_nam','$RFI_Received_by','$RFI_Received_date_time','$RFI_Scanned_documentfile')";
...
echo $Survey_document;
  $insert_q2="UPDATE tbl_rfi_lab SET Survey_Surveyor_name='$Survey_Surveyor_name', Survey_Date_time='$Survey_Date_time', Survey_report='$Survey_report',
...
if(isset($_REQUEST['update2'])){
  ...
  $insert_q3="UPDATE tbl_rfi_lab SET Inspection_inspector_name='$Inspection_inspector_name', Inspection_Date_time='$Inspection_Date_time', Inspection_report='$Inspection_report',
...
if(isset($_REQUEST['update3'])){
  ...
  $insert_q4="UPDATE tbl_rfi_lab SET Quality_MT_Engineer_name='$Quality_MT_Engineer_name', Quality_testing_Date_time='$Quality_testing_Date_time', Quality_test_perfomed='$Quality_test_perfomed',
...
if(isset($_REQUEST['update0'])){
  ...
  $insert_q6="UPDATE tbl_rfi_lab SET lid='$lid',contractor_no='$contractor_no', section='$section', site='$site',
   ...
   RFI_Received_by='$RFI_Received_by' , RFI_Received_date_time='$RFI_Received_date_time', RFI_Scanned_document='$RFI_Scanned_documentfile' WHERE rfi_id='$rfi_id'";
     ...
     <div class=" page-body-wrapper" id="pagebodywraper">
      ...
      <div class="content-wrapper" style="">
        <h4 class="text-center text-34 mb-4" style="  letter-spacing: 4px">  REQUEST FOR INFORMATION (RFI) </h4> 
          ...
          <div class="row">
            ...
            <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <select class="form-control  bg-light text-dark" id="lid" name="lid" style="width: 60%;">
                
                    <?php $pdSQL = "SELECT * FROM  structures  order by lid";
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input class="form-control" id="rfi_Date" placeholder ="yyyy-mm-dd" type="text" name="rfi_Date" value="<?php echo substr($rfi_Date,0,10); ?>"required/>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="rfi_sub_date_time"  value="<?php echo substr($rfi_sub_date_time,0,10); ?>" id="rfi_sub_date_time" placeholder="yyyy-mm-dd" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="rfi_contractor_rep_name"  value="<?php echo $rfi_contractor_rep_name; ?>"  id="rfi_contractor_rep_name" placeholder="" required/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="form-control" name="RFI_Received_date_time"  value="<?php echo substr($RFI_Received_date_time,0,10); ?>" id="RFI_Received_date_time" placeholder="yyyy-mm-dd" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="timepicker form-control" name=""  value="<?php echo substr($RFI_Received_date_time,11,17); ?>"  id="" placeholder="yyyy-mm-dd" />
            ...
            <div class="pt-2 text-end pb-3" > 
                ...
                <button  class="btn btn-primary button-33 py-2 me-3" type="submit" <?php if(isset($rfi_id)&&$rfi_id!=0) { ?> name="update0" id="update0"<?php } else {?> name="save" id="save"<?php }?>
        ...
        <h4 class="card-title text-center pt-4 pb-1">Survey Details</h4>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="form-control" name="Survey_Date_time" value="<?php echo substr($Survey_Date_time,0,10); ?>"  id="Survey_Date_time" placeholder="yyyy-mm-dd" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="timepicker form-control" name="" value="<?php echo substr($Survey_Date_time,11,17); ?>" id="" placeholder="hh:mm:ss" />
                            <script type="text/javascript">$('.timepicker').wickedpicker({now: '00:00', twentyFour: true, showSeconds: false});</script>
                          </div>
                        </div>
                      </div>
            ...
            <!-- Save button -->
            <div class="pt-2 text-end pb-3" > 
                <button  class="btn btn-primary button-33 py-2 me-3" type="submit" name="update1" id="update1"  style="width:15%">Update</button>
            </div>
            <div class="style-five row" >  </div>
        ...
        <h4 class="card-title text-center pt-4 pb-1">Inspection Details</h4>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="form-control" name="Inspection_Date_time" value="<?php echo substr($Inspection_Date_time,0,10); ?>" id="Inspection_Date_time" placeholder="yyyy-mm-dd" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="timepicker form-control" name="" value="<?php echo substr($Inspection_Date_time,11,17); ?>" id="" placeholder="yyyy-mm-dd" />
                            <script type="text/javascript">$('.timepicker').wickedpicker({now: '00:00', twentyFour: true, showSeconds: false});</script>
                          </div>
                        </div>
                      </div>
            ...
            <!-- Save button -->
            <div class="pt-2 text-end pb-3" > 
                <button  class="btn btn-primary button-33 py-2 me-3" type="submit" name="update2" id="update2" style="width:15%">Update</button>
            </div>
            <div class="style-five row" >  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="form-control" name="" value="<?php echo substr($Quality_testing_Date_time,0,10); ?>" id="Quality_testing_Date_time" placeholder="yyyy-mm-dd" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" class="timepicker form-control" name="" value="<?php echo substr($Quality_testing_Date_time,11,17); ?>" id="" placeholder="yyyy-mm-dd" />
                            <script type="text/javascript">$('.timepicker').wickedpicker({now: '00:00', twentyFour: true, showSeconds: false});</script>
                          </div>
                        </div>
                      </div>
            ...
            <!-- Save button -->
            <div class="pt-2 text-end pb-3" > 
                <button  class="btn btn-primary button-33 py-2 me-3" type="submit" name="update3" id="update3" style="width:15%">Update</button>
            </div>
            <div class="style-five row" >  </div>
            ...
            <div class="pt-2 text-end pb-3" > 
                ...
                <button  class="btn btn-primary button-33 py-2 me-3" type="submit" name="update4"  id="update4"  style="width:15%">Update</button>
            </div>
            <div class="style-five row" >  </div>
