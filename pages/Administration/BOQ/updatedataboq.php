...
if($eeCount > 0){
	 $res_rest=$objDb->dbFetchArray();
  $cur_1_rate 					= $res_rest['cur_1_rate'];
  $cur_2_rate 					= $res_rest['cur_2_rate'];
  $cur_3_rate 					= $res_rest['cur_3_rate'];
  $base_cur 				= $res_rest['base_cur'];
  $cur_1 					= $res_rest['cur_1'];
  $cur_2 					= $res_rest['cur_2'];
  $cur_3 					= $res_rest['cur_3'];
