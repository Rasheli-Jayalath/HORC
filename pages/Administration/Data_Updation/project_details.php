...
$objIC->setProperty("pid",$pid);
	if($objIC->actProject($_POST['mode'])){
		...
		$objCur->actCurrency($_POST['mode']);
		 #Check if the new dates are added
			...
			//$count_title= count($arr_yh_title);
		...
		$lid=0;
			 ...
			 $sql_pro1="INSERT INTO boqdata(parentcd,  activitylevel,stage,factor,itemcode,itemname,weight, isentry, aorder,lid) 
	...
	$activitylevel=0;
		...
		$lid=0;
				 ...
				 $sql_pro1="INSERT INTO maindata(parentcd,  activitylevel,itemcode,itemname,weight, isentry, aorder,lid) 
		Values( ".$parentcd.",  '".$activitylevel."' , '".$itemcode."' , '".$itemname."' , '".$weight."' , '".$isentry."' , '".$aorder."' , ".$lid.")";
	...
	$activitylevel=0;
		...
		$lid=0;
				 ...
				 $sql_pro1="INSERT INTO kpidata(parentcd,  activitylevel,itemcode,itemname,weight, isentry, aorder,kpi_temp_id,lid) 
		Values( ".$parentcd.",  '".$activitylevel."'   , '".$itemcode."' , '".$itemname."' , '".$weight."' , '".$isentry."' , '".$aorder."', ".$kpi_temp_id." , ".$lid.")";
