...
<?php
       ...
       {
         $pgid = $_REQUEST['pgid'];
         $progressqty = $_REQUEST['progressqty'];
       $sql_update ="UPDATE progress_copy SET  progressqty='$progressqty' where pgid=$pgid ";
  ...
  <link href="lightbox/css/lightbox.css" rel="stylesheet" /> 
   ...
   <div class="container-fluid">
    <div class=" grid-margin stretch-card " style = "margin-top: 3%;">
          ...
          if(isset($_GET['pgid'])) { 
            $verifiedIPCId = $_GET['pgid'];
            $sSQL = "SELECT * FROM progress_copy where pgid= $verifiedIPCId " ;
            $objDb2->dbQuery($sSQL);
            $j=0;
          ...
          ?>
                  ...
                  <form class="forms-sample pt-3" name="form2" action="edit_before_verify.php?pgid=<?php echo $verifiedIPCId; ?>" target="_self" method="post"  enctype="multipart/form-data" onSubmit="return required()"  >


					<div class="form-group row">
                    <div class="text-end col-sm-6"><label><?php echo "Item Name :";?></label>
                      </div>
                      <div class="text-start col-sm-6" >
					  <span style="font-weight:bold" ><?php echo $res_e2['itemname'];?></span>
                      </div>
				...
				<div class="form-group row">
                    <div class="text-end col-sm-6"> <label><?php echo "Progress QTY :";?></label> </div>
                      <div class="text-start col-sm-6">
                      <?php  if(isset($_REQUEST['update'])) { ?>
                        <span style=" " ><?php echo $res_e2['progressqty'];?></span>
           <?php } else { ?>
					  <input class="form-control"  type="text" name="progressqty" id="progressqty" value="<?php echo $res_e2['progressqty'];?>"  style="width: 60%;"  placeholder=" Revision No " Required>
            <?php } ?>  
          </div>
        </div>
