...
$(function () {
        $('#container_sv').highcharts({
            ...
            xAxis: {
               ...
               categories: [
                   <?php echo $objEva->GetScheduleVarianceMonth($start,$end);?>
            ...
            series: [{
                name: 'SV',
                data: [<?php echo $objEva->GetScheduleVarianceData($start,$end);?>]
            }]
        });
    });
   ...
   <tr>
     ...
     <div id="container_sv" style="min-width:1200px; height: 400px; margin: 0 auto"></div>
     </td>
