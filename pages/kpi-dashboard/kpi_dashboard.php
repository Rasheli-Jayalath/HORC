          ...
          <!-- Page Data Goes Here -->
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
              <div class="offcanvas-header">
                <h2 class="offcanvas-title" id="offcanvasExampleLabel">KPI Dashboard</h2>
              ...
              <div class="offcanvas-body">
                ...
                <div class="row">
                <form cclass="form-inline"  action="">
                <input type="hidden" id="kpi_temp_id" name="kpi_temp_id" value="<?php echo $kpi_temp_id;?>" />
               <div class="form-group">
                      <label for="exampleInputstart_date"><strong><?php echo START;?>:</strong></label>
                     
              
              <input type="text" id="start_date" name="start_date" value="<?php 
			  if(isset($_REQUEST["start_date"])&&$_REQUEST["start_date"]!=""&&$_REQUEST["start_date"]!="1970-01-01") 
			   echo $_REQUEST["start_date"]; 
			  else 
			  echo date("Y-m-d", strtotime($start_kpi_date));?>" class="form-control"/>
            
                    </div>
               <div class="form-group">
                      <label for="exampleInputend_date"><strong><?php echo END;?>:</strong></label>
                      
              <input type="text" id="end_date" name="end_date" value="<?php 
			  if(isset($_REQUEST["end_date"])&&$_REQUEST["end_date"]!=""&&$_REQUEST["end_date"]!="1970-01-01") 
			  echo $_REQUEST["end_date"]; 
			  else 
			  echo date("Y-m-d", strtotime($end_kpi_date));?>" class="form-control"/>
            
                    </div>
            	<div class="form-group">
                      <label for="exampleInputselectBox1"><strong>Project/Component/Packages</strong></label>
                      <select class="form-control" id="selectBox1" name="selectBox1" onchange="getprolevel(this);">
                        <option class="text-muted" value="0">Component/Package</option>

                      <?php        

                          $ObjKpiDash->setProperty("prolvlid",0); 
...
function reportgenButton(strval,itemname) {
      ...
      var strURL="newTableReport_testing.php?kpiids="+strval+"&itemname="+itemname;
        showSpinner();
          var req= getXMLHTTP();
...
var xhr = new XMLHttpRequest();
    ...
    xhr.open("GET", "kpi_graphmain.php", true);
    xhr.send(null);
    ...
    yAxis: {
     ...
     $.getJSON('kpi_graph.php', function(json) {
...
function reportgenPageLoad(strval,strname,start_date,end_date) {
         
            var strURL="newTableReport_testing.php?kpiids="+strval+"&itemname="+strname+"&start_date="+start_date+"&end_date="+end_date;
  ...
  <script>
      window.onload = function() {
		...
		var end_date = document.getElementById('end_date').value; 
          ...
          reportgenPageLoad(secondOptionValue,secondOptionText,start_date,end_date);
