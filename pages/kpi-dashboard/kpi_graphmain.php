...
$sql1 = "select min(a_month) as start, max(a_month) as end, planned,actual from kpi_dashboard_graph";
$objDb->dbQuery($sql1);
...
$sql2 = "select planned from kpi_dashboard_graph";
$objDb->dbQuery($sql2);
$i=0;
$j=0;
...
$sql2 = "select actual from kpi_dashboard_graph";
$objDb->dbQuery($sql2);
