...
if(isset($_REQUEST['save']))
{
	...
	echo   $target_file1=$file_path.$image1file;
	 //$target_file = $file_path . basename($_FILES['al_file']["name"]);
...
$sql_pro= $objDb->dbQuery("INSERT INTO t012issues (pid, iss_no, iss_title, iss_detail, iss_status, action_status, iss_remarks,attachment,iss_date,lid,image1,image2) Values(".$pid.",'".$iss_no."', '".$iss_title."', '".$iss_detail."', '".$iss_status."', '".$iss_action."', '".$iss_remarks."', '".$flink."', ".$iss_date.", '".$lid."', '".$image1file."', '".$image2file."')");
...
$pdSQL1="SELECT nos_id, pid, iss_no, iss_title, iss_detail, iss_status, iss_action,action_status, iss_remarks, attachment, iss_date,lid FROM t012issues  where pid = ".$pid." and  nos_id = ".$nos_id;
...
if(isset($_REQUEST['update']))
{
	...
	if($flink!="" && $image1file!="" && $image2file!="")
	{
	echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' , attachment='$flink' , image1='$image1file', image2='$image2file',iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
	else if($flink=="" && $image1file!="" && $image2file!="")
	{
	echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' ,  image1='$image1file', image2='$image2file',iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
	else if($flink!="" && $image1file=="" && $image2file!="")
	{
echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' , attachment='$flink' ,image2='$image2file',iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	...
	{
	echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' , attachment='$flink' ,iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
	else if($flink=="" && $image1file=="" && $image2file!="")
	{
	echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' ,image2='$image2file',iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
	else if($flink=="" && $image1file!="" && $image2file=="")
	{
	echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' ,image1='$image1file',iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
	else
	{
echo $sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  action_status='$iss_action', iss_remarks='$iss_remarks' ,iss_date='$iss_date', lid='$lid'  where nos_id=$nos_id";
	}
                          ...
                          <div class="form-group row">
						   ...
						   ?>
                             ...
                             <label class="form-check-label" style="padding-left: 1%;">
                                  <input  type="radio" class="form-check-input"  id="iss_status" name="iss_status" value="1" <?php if($iss_status==1) echo 'checked="checked"';?>/> Active
                            </label>
                       ...
                       <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                             ...
                             <label class="form-check-label" style="padding-left: 1%;">
                                  <input  type="radio" class="form-check-input"  id="action_status" name="action_status" value="1"  checked="checked"/> Pending
                            </label>
                            <label class="form-check-label " style="padding-left: 10%;">
                                   <input  type="radio" class="form-check-input" id="action_status" name="action_status" value="2"  <?php if($action_status==2) echo 'checked="checked"';?> /> Resolved
                            </label>
