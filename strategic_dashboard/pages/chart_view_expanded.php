...
<div class="container-scroller">
    ...
    <!-- partial:partials/_navbar.php -->   <?php include '../partials/_navbar.php';?>  <!-- partial -->
      ...
      <div class="row " style="padding-top: 80px;">
                    ...
                    <h4 class="pb-3" >Project Information 
          <?php if($adminflag==1)
                {
                 ?><span style="float:right"><form action="sp_project_info_update.php" target="_self" method="post"><input type="submit" class="btn btn-primary btn-37 mb-4 py-2 px-4" style="margin-top: -8%;"  name="p_update" id="p_update" value="Update"  /></form></span><?php }?></h4>
                    <tbody>
                      <tr>
                          ...
                          <?php if($adminflag==1)
								  {
								   ...
								   ?><span style="float:right"><form action="sp_progress_graph.php" target="_self" method="post"><input type="submit" class="btn btn-primary btn-37 mb-4 py-2 px-4" style="margin-top: -8%;"  name="g_update" id="g_update" value="Manage"  /></form></span><?php } ?>
...
?>  
  ...
  <h4  style="margin-bottom: -10px;">Progress of Major Items  as of </h4>
<?php if($adminflag==1)
								  {
								   ?>
                   <span class="" style="float:right; color : #ccc;"><form action="sp_major_items.php" target="_self" method="post"><input type="submit" name="i_update" id="i_update" value="Update" class="btn btn-primary btn-37 mb-4 py-2 px-4" style="margin-top: -8%;"  /></form></span><?php }?>
                   <br>
                   <?php echo  "<h5>".date('F d, Y',strtotime($chartdatad['max_date']))  ."</h5>";   ?>
                    <div class="table-responsive">  
  <table  style="" class="table ">
    <tr>
                          <th class="px-0 text-center" rowspan="2" style=" font-size: 14px; font-weight: 700;" >Description</th>
                          <th class="px-0 text-center" colspan="2" style=" font-size: 14px; font-weight: 700;" >Progress</th>
                        </tr>
                        <tr>
                          <th class="px-0 text-start" style=" font-size: 14px; font-weight: 700;" >Planned</th>
                          <th class="px-0 text-end" style=" font-size: 14px; font-weight: 700;" >Achieved</th>
                        </tr>
                      <tbody>
<?php
		while ($apdata = $apSQLResult->fetch_array() ) {
					echo '<tr><td  class="px-0 py-0" >'.$apdata['act_id'].'</td><td  class="px-0 py-2 text-start"  align="right">'.number_format($apdata['planned_percent'],2). " %".'</td><td  class="px-0 py-0 text-end"  align="right">'.number_format($apdata['actual_percent'],2). " %". '</td></tr>';
		}
?> 
      </tbody>
  ...
  ?>  
                        <h4 class = "pb-3" >Project Expected Completion Dates 
              <?php if($adminflag==1)
                    {
                     ?><!--<span style="float:right"><form action="sp_financial_info_input.php?fid=<?php echo $fid; ?>" target="_self" method="post"><input type="submit" name="f_update" id="f_update" value="Update"  /></form></span>--><?php } ?></h4>
                        <div class="table-responsive">  
  <table  style="" class= "table">
                    <tr>
                            <th class="px-0 text-center"  align="center"  style=" font-size: 14px; font-weight: 700;" >Component</th>
                            <th class="px-0 text-center"  align="center"  style=" font-size: 14px; font-weight: 700;"> Planned Date</th>
                            <th class="px-0 text-center"  align="center"  style=" font-size: 14px; font-weight: 700;"> Expected Date</th>
                          </tr>
                       <tbody>
                         <tr>
                           <td align="center" class="px-0">Overall Project</td>
                           <td align="center" class="px-0">22-02-2019</td>
                           <td align="center" class="px-0">22-02-2019</td>
                         </tr>
                       <tr>
                           <td align="center" class="px-0">Unit - 17</td>
                           <td align="center" class="px-0">25-02-2018</td>
                           <td align="center" class="px-0">25-02-2018</td>
                         </tr>
              <tr>
                           <td align="center" class="px-0">Unit - 16</td>
                           <td align="center" class="px-0">30-04-2018</td>
                           <td align="center" class="px-0">30-04-2018</td>
                         </tr>
               <tr>
                           <td align="center" class="px-0">Unit - 15</td>
                           <td align="center" class="px-0">30-05-2018</td>
                           <td align="center" class="px-0">30-05-2018</td>
                         </tr>
                </tbody>
                      </table>
                        ...
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              ...
                              <h4 class="pb-4">Financial Status till Date in <?php echo $proj_cur;?> 
					  <?php if($adminflag==1)
								  {
                        ...
                        <div class="col-12 grid-margin stretch-card">
                          <div class="card ">
                            ...
                            <tbody >
                                      ...
                                      <tr style="padding:0px; margin:0px;">
                                        <td style="" class="px-1 py-1"><span style="width:50%; height:100%; padding:0px; font-size: small; margin:0px;">
                                          ...
                                          </form></span></td><td width="50%" style="  " class="px-1 py-1">
                                      ...
                                      <tr style="padding:0px; margin:0px;"><td width="50%" style="  " class="px-1 py-1">
                                        <form action="sp_contmob.php">
                                          ...
                                          Contractor's Mobilization</button></form></td><td width="50%" style="  " class="px-1 py-1">
                                      ...
                                      <tr style="padding:0px; margin:0px;"><td width="50%" style="  " class="px-1 py-1" >
                                        <form action="sp_cashflow.php">
                                          ...
                                          </form></td><td width="50%" style="  " class="px-1 py-1">
                                      ...
                                      <tr style="padding:0px; margin:0px;"><td style=""  class="px-1 py-1"><span style="width:50%; height:100%; padding:0px; margin:0px;">
                                      ...
                                      <tr><td width="50%" style="  " class="px-1 py-1">
                                  ...
                                  <td width="50%" style="  " class="px-1 py-1">
                                    <form action="sp_dpm_vo2.php">
                                      ...
                                      <tr><td style="width:50%;"><span style="width:50%; height:100%; padding:0px; margin:0px;">
                                        ...
                                        <td style="width:50%">     <span class = "text-end" style="width:50%; height:10%; padding : 0px; margin: 0px; float: right"><a href="http://www.egcpakistan.com/index.php?id=it" target="_blank"><img src="sj.png" width="200px" style="marging-top:10px; "></a></span> 
        </td>
                                      </tr>
                                    </tbody>
    </table> 
...
?>  
                   ...
                   <h4 class="pb-3">Major Issues and Recommendation <?php if($adminflag==1)
								  {
								   ?><span style="float:right"><form action="sp_issues_info.php" target="_self" method="post"><input type="submit" name="i_update" id="i_update" value="Manage"  class="btn btn-primary btn-37 mb-4 py-2 px-4" style="margin-top: -8%;" /></form></span><?php } ?></h4> 
                   
              

<marquee id="MARQUEE1" style="text-align: left; float: left; height:78%;" scrollamount="3" onmouseout="this.start();" onmouseover="this.stop();" direction="up" behavior="scroll">
...
?>
        ...
        <!-- partial:partials/_footer.php --> <?php include '../partials/_footer.php';?> <!-- partial -->
