...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t0171bridges (pid, serial, description, total, inprogress, completed) Values(".$pid.",".$serial.", '".$description."',".$total.",".$inprogress.", ".$completed.")");
	if ($sql_pro == TRUE) {
