...
{
mysqli_query($db, "Delete from mis_tbl_2_components where cid=".$_REQUEST['cid']);
}
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;">     <td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Components</span><span style="float:right">
 </h4> 
...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_component_input.php';" > Add New Record </button>
<?php } 
...
<div style="" class="table-responsive bg-light">
  <table width="100%" class="table table-bordered">
							  ...
							  { ?>
                        <tr>
                          <td class="py-2"  align="center"><?php echo $pdData['code'];?></td>
                          <td class="py-2"  align="left"><?php echo $pdData['detail'];?></td>
                          <?php if($adminflag==1)
								  {
								   ?>
						   <td class="py-2"  align="right"><span style="float:left"><form action="sp_component_input.php?cid=<?php echo $pdData['cid'] ?>" method="post">
              ...
              </form></span><span style="float:right"><form action="sp_component.php?cid=<?php echo $pdData['cid'] ?>" method="post">
