...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO mis_tbl_2_components (pid, code, detail) Values(".$pid.",'".$serial."', '".$description."' )");
	if ($sql_pro == TRUE) {
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Components </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_component_input.php" target="_self" method="post" class=" col-sm-8" >
