...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t024project_comprogress_table (pid, act_id, weight, ppt_planned, ppt_actual) Values(".$pid.",'".$act_id."',".$weight. ", ". $ppt_planned.",".$ppt_actual.")");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_component_wise_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
                    ...
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Component Name: : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="act_id" id="act_id" value="<?php echo $act_id; ?>"   />
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="weight" id="weight" value="<?php echo $weight; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>       
            ...
            <div class="row ">
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Planned Percent : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text"  name="ppt_planned" id="ppt_planned" value="<?php echo $ppt_planned; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>       
            ...
            <div class="row pb-5 ">
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Planned Actual : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="ppt_actual" id="ppt_actual" value="<?php echo $ppt_actual; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>       
