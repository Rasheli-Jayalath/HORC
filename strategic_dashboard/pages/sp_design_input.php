...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t0101designprogress (pid, serial, description, total, submitted, revision, approved, approvedpct) Values(".$pid.",".$serial.", '".$description."',".$total.",".$submitted.",".$revision.", ".$approved.", ".$approvedpct.")");
	if ($sql_pro == TRUE) {
