...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_dphoto_input.php';" > Manage Photos </button>
<?php } 
...
<!--  -->
              ...
              if( $pdSQLResult ->num_rows>= 1){
                while($result =  $pdSQLResult->fetch_array()){
                ...
                {
                ?>
                 <a href="sp_dphoto_large.php?photo=<?php echo $result['al_file'];?>&phid=<?php echo $result['phid'];?>" target="_parent" ><img src="<?php echo $data_url.$result['al_file']; ?>"  class="col-3" width="" height="" border="0" /></a>
                <?php
                }
                else
                {
                ?>
                         ...
                         <img src="images/tag_small.png"  border="0" width="" height=""  class="col-3"/></a>
                         <?php
                 }
                };?></span>
                    <?php 
