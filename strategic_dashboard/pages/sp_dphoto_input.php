...
@unlink($al_file.$al_file);
 mysqli_query($db, "Delete from t027project_dphotos where phid=".$_REQUEST['phid']);
...
{ 
	...
	{
	$sql_pro=mysqli_query($db, "INSERT INTO t027project_dphotos(pid, al_file,ph_cap) Values(".$pid.", '".$file_name."', '".$ph_cap."' )");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_dphoto_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <table width="100%" class="table table-bordered">
                        ...
                        <tr>
						  ...
						  <?php if($adminflag==1)
								  {
								   ?>
						   <td class="py-2"  align="right"><span style="float:left"><form action="sp_dphoto_input.php?phid=<?php echo $pdData['phid'] ?>" method="post">
              ...
              </form></span><span style="float:right"><form action="sp_dphoto_input.php?phid=<?php echo $pdData['phid'] ?>" method="post">
