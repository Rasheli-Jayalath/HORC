...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t028dpm_vo2progress (pid,description, code, weight,  start, finish, astart, afinish, tamount, pamount, actamount) Values(".$pid.", '".$description."' , '".$code. "' , '".$weight."' , '".$start."' , '".$finish."' , '".$astart."' , '".$afinish."' , '".$tamount."' , '".$pamount."' , '".$actamount."' )");
	if ($sql_pro == TRUE) {
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> VO2 Progress </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_dpm_vo2_input.php" target="_self" method="post" class=" col-sm-8" >
          ...
          <div class="row  pt-5">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Code : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="code" id="code" value="<?php echo $code; ?>"/>
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Milestone Name : </label>
                            <div class="col-sm-8 text-start">
            ...
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Weight : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"   name="weight" id="weight" value="<?php echo $weight; ?>"  />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"   name="start" id="start" value="<?php echo $start; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  End Date : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"   name="finish" id="finish" value="<?php echo $finish; ?>" />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Actual Start Date : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="astart" id="astart" value="<?php echo $astart; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Actual End Date : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="afinish" id="afinish" value="<?php echo $afinish; ?>"   />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Total Amount : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="tamount" id="tamount" value="<?php echo $tamount; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row pb-5 ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Planned Amount : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="pamount" id="pamount" value="<?php echo $pamount; ?>" />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Actual Amount : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="actamount" id="actamount" value="<?php echo $actamount; ?>" />
                            </div>
                          </div>
                        </div>
            </div>
