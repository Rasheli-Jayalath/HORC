...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Earned Value Analysis (Tabular Data) </h4> 
...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_eva_input.php';" > Add New Record </button>
<?php } 
  ...
  <table width="100%" class="table table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th width="10%" style="text-align:center">value (<?php echo $proj_cur;?>)</th>
								  <?php if($adminflag==1)
								  {
								   ?>
                        ...
                        <tr>
                          ...
                          <td class="py-2"  align="center"><?php echo $pdData['nolines'];?></td>
                          <?php if($adminflag==1)
								  {
								   ?>
						  <td class="py-2"  align="right"><span style="float:left"><form action="sp_eva_input.php?rcid=<?php echo $pdData['rcid'] ?>" method="post">
            ...
            </form></span><span style="float:right"><form action="sp_eva.php?rcid=<?php echo $pdData['rcid'] ?>" method="post">
