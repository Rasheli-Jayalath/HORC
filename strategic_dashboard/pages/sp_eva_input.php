...
if(isset($_REQUEST['save']))
{
	...
	$nolines=$_REQUEST['nolines'];
 	...
 	$message="";
	$pgid=1;
echo $sql_pro=mysqli_query($db, "INSERT INTO t0211eva (pid, serial, description, nolines) Values(".$pid.",".$serial.", '".$description."','".$nolines."' )");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_eva_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
            ...
            <div class="row ">
                       <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Indicator : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="description" id="description" value="<?php echo $description; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>
            ...
            <div class="row pb-5 ">
                       <div class="col-md-1"></div>
                        <div class="col-md-9  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Value: (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="nolines" id="nolines" value="<?php echo $nolines; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>
