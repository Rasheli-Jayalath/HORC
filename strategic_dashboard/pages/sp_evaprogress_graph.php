...
{
mysqli_query($db, "Delete from t0211eva_progress_graph where ppg_id=".$_REQUEST['ppg_id']);
}
...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_evaprogress_graph_input.php';" > Add New Record </button>
<?php } 

?>
<button type="button" class="col-sm-2 button-33" onclick="history.back()" >  Back </button>
...
<div style="" class="table-responsive bg-light">
  <table width="100%" class="table table-bordered">
						...
						<td class="py-2"  align="center"><?php echo $i;?></td>
                          <td class="py-2"  align="center"><?php echo $ppg_date_f; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['planned']; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['actual']; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['earned']; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['cpi']; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['spi']; ?></td>
                          <td class="py-2"  align="right"><?php echo $pdData['tcpi']; ?></td>
						  <?php if($adminflag==1)
								  {
								   ?>
						   <td class="py-2"  align="right"><span style="float:left"><form action="sp_evaprogress_graph_input.php?ppg_id=<?php echo $pdData['ppg_id'] ?>" method="post">
              ...
              </form></span><span style="float:right"><form action="sp_evaprogress_graph.php?ppg_id=<?php echo $pdData['ppg_id'] ?>" method="post">
