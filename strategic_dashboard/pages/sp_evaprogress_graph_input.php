...
//echo mysqli_num_rows($pdSQLResult);
...
{
$sql_pro=mysqli_query($db, "INSERT INTO t0211eva_progress_graph (pid, planned, actual, ppg_date, earned, cpi, spi,tcpi) 
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Earned Value Analysis Graphical Data </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_evaprogress_graph_input.php" target="_self" method="post" class=" col-sm-8" >
          ...
          <div class="row  pt-4">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Month : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="ppg_date" id="ppg_date" value="<?php echo $ppg_date_f; ?>"  />
                            <p>yyyy-mm</p>
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Planned (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="planned" id="planned" value="<?php echo $planned; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Actual (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="actual" id="actual" value="<?php echo $actual; ?>" />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Earned (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="earned" id="earned" value="<?php echo $earned; ?>" />
                            </div>
                          </div>
                        </div>
            </div>
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  CPI : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="cpi" id="cpi" value="<?php echo $cpi; ?>"   />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  SPI : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="spi" id="spi" value="<?php echo $spi; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  pb-5">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  TCPI-1 : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"   name="tcpi" id="tcpi" value="<?php echo $tcpi; ?>" />
                            </div>
                          </div>
                        </div>       
