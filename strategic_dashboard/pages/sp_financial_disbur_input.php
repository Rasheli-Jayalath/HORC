...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t0029financial_disbursement(pid, serial, type, description, fmonth, amount_claim, amount_paid) Values(".$pid.",".$serial.", '".$type."', '".$description."', '".$fmonth."' ,".$amount_claim.", ".$amount_paid.")");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_financial_disbur_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
          ...
          <div class="row  pt-4">
                        ...
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Component : </label>
                            <div class="col-sm-8 text-start">
                            <select class="form-control bg-light text-dark" style=""   onchange=""  id="type" name="type" Required>
            ...
            <div class="row  ">
                        ...
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="fmonth" id="fmonth" value="<?php if($fmonth!=""&&$fmonth!="NULL")echo date('Y-m',strtotime($fmonth)); ?>"/>
                              <p>(yyyy-mm)</p>
                            </div>
                          </div>
                        </div>
            ...
            <div class="row  pb-5">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Amount Claimed (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="amount_claim" id="amount_claim" value="<?php echo $amount_claim; ?>" />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Amount Paid (<?php echo $proj_cur;?>) : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"  name="amount_paid" id="amount_paid" value="<?php echo $amount_paid; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
