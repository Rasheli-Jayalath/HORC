...
{
  $db->query ("Delete from t0201finstatus where finid=".$_REQUEST['finid']);
}
...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_finstatus_input.php';" > Add New Record </button>
<?php } 
 ...
 <div  class="table-responsive">
  <table width="100%" class="table table-bordered  table-striped" >
                        ...
                        <tr>
                          ...
                          <td class="py-3"align="right"><?php echo number_format($pdData['amount'],0);?></td>
						    <?php if($adminflag==1)
								  {
								   ?>
						   <td class="py-3" align="right"><span style="float:left"><form action="sp_finstatus_input.php?finid=<?php echo $pdData['finid'] ?>" method="post"><button type="submit" name="edit" class="btn btn-outline-primary btn-fw px-1  py-1 "  id="edit" value="Edit" >  <i class="ti-pencil btn-icon-prepend" style="font-size: 11px;"></i>  
                            </button></form></span>
                            </td>
                            <td  class="py-3" align="right">
               <span style="float:right"><form action="sp_finstatus.php?finid=<?php echo $pdData['finid'] ?>" method="post"><button type="submit" name="delete" id="delete" value="Delete"   class="btn btn-outline-danger btn-fw px-1 py-1 m-0"  onclick="return confirm('Are you sure?')" >					   <i class="ti-trash btn-icon-prepend" style="font-size: 11px;"></i> 
        					</button></form></span></td>
						   <?php
						   }?>
                        </tr>
