...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t0201finstatus (pid,serial,description, amount) Values(".$pid.",'".$serial."', '".$description."',".$amount.")");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_finstatus_input.php" target="_self" method="post" class=" col-sm-8" >
            ...
            <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            ...
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="serial" id="serial" value="<?php echo $serial; ?>"  />
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="file"  name="description" id="description" value="<?php echo $description; ?>" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>
                       ...
                       <div class="col-md-1"></div>
                        <div class="col-md-9  pb-5 ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="file"  name="amount" id="amount" value="<?php echo $amount; ?>" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>
