...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_gphoto_input.php';" > Add New Record </button>
<?php } 
...
<?php  
     ...
     if( $pdSQLResult ->num_rows>= 1){
       ...
       {
       ?>
        <a href="sp_gphoto_large.php?photo=<?php echo $result['al_file'];?>&phid=<?php echo $result['phid'];?>" target="_parent" ><img src="<?php echo $data_url.$result['al_file']; ?>" class="col-3" width="" height="" style="    " /></a>
       <?php
       }
       else
       {
       ?>
                ...
                <img src="images/tag_small.png"  class="col-3" border="0" width="" height=""/></a>
                <?php
        }
       };?></span>
           <?php 
