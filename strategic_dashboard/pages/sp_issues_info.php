...
{
mysqli_query($db, "Delete from t012issues where iss_id=".$_REQUEST['iss_id']);
}
...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_issues_info_input.php';" > Add New Record </button>
<?php } 
...
<div style=""  class="table-responsive">
  <table width="100%" class="table table-bordered table-striped">
                              ...
                              <thead>
                                <tr>
                                  <th width="1%" style="text-align:center; font-size:13px; vertical-align:middle">Issue No</th>
                                  <th width="12%" style="text-align:center; font-size:13px;">Title</th>
                                  <th width="40%" style="text-align:center;font-size:13px;">Detail</th>
								  ...
								  {
								   ?>
								  <th width="9%" colspan="2"style="text-align:center;font-size:13px;">Action</th>
								  <?php
								  }
								  ?>
                        ...
                        <tr>
                          ...
                          <td align="left" style="font-size:13px"><?php echo wordwrap($pdData['iss_title'],25,"<br>\n");?></td>
                          <td align="left" style="font-size:13px"><?php echo wordwrap($pdData['iss_detail'],40,"<br>\n");?></td>
                          <td align="left" style="font-size:13px"><?php echo wordwrap($pdData['iss_status'],25,"<br>\n");?></td>
                          <td align="left" style="font-size:13px"><?php echo wordwrap($pdData['iss_action'],25,"<br>\n");?></td>
						  <td align="left" style="font-size:13px"><?php echo wordwrap($pdData['iss_remarks'],25,"<br>\n");?></td>
						  <?php if($adminflag==1)
								  {
								   ?>
						   ...
						   <button type="submit" name="edit" id="edit" value="Edit" class="btn btn-outline-primary btn-fw px-1  py-1 " style="margin-top: 0; margin-bottom: 0; ">   <i class="ti-pencil btn-icon-prepend" ></i>  
                            </button></form></span><span style="float:right"> </td>
							<td align="right">
						   <form action="sp_issues_info.php?iss_id=<?php echo $pdData['iss_id'] ?>" method="post">
						   <button type="submit" name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" class="btn btn-outline-danger btn-fw px-1  py-1 " style="margin-top: 0; margin-bottom: 0; ">				   <i class="ti-trash btn-icon-prepend" ></i> 
        					</button></form></span></td>
						   <?php
						   }
						   ?>
