...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t012issues (pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks) Values(".$pid.",'".$iss_no."', '".$iss_title."', '".$iss_detail."', '".$iss_status."', '".$iss_action."', '".$iss_remarks."')");
	if ($sql_pro == TRUE) {
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Major/Current Issues </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_issues_info_input.php" target="_self" method="post" class=" col-sm-8" >
          ...
          <div class="row  pt-4">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Issue No : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="iss_no" id="iss_no" value="<?php echo $iss_no; ?>"   required/>
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Title : </label>
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; "  name="iss_title"><?php echo $iss_title; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Detail : </label>
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="iss_detail"><?php echo $iss_detail; ?> </textarea>
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Status : </label>
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="iss_status"><?php echo $iss_status; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row pb-5 ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Action : </label>
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="iss_action"><?php echo $iss_action; ?> </textarea>
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Remarks : </label>
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="iss_remarks"><?php echo $iss_remarks; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
