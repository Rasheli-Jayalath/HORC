...
$sql_pro=mysqli_query($db, "INSERT INTO t002project (srid, proj_name, pcolor) Values(".($max_srid+1).", '".$proj_name."', '".$pcolor."')");

$max_id=mysqli_insert_id();
// $max_id= '';

$sql1=mysqli_query($db, "INSERT INTO t024project_progress_table (pid, act_id) select ".$max_id." as pid, act_name  from t011activities order by act_order");
$sql1=mysqli_query($db, "INSERT INTO t003funds (pid) VALUES (".$max_id.")");
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Project List </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_maindashboard_input.php" target="_self" method="post" class=" col-sm-8" >
                    ...
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Project Name : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="proj_name" id="proj_name" value="<?php echo $proj_name; ?>"  />
                            </div>
                          </div>
                        </div>
