...
{
mysqli_query($db, "Delete from t024project_progress_table where ppt_id=".$_REQUEST['ppt_id']);
}
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Major Items Progress </h4> 
...
<!-- <button type="button" class="col-sm-2 button-33" onclick="location.href='sp_major_items_input.php';" > Add New Record </butto
n> -->
<?php } 
  ...
  <table width="100%" class="table table-bordered table-striped">
                        ...
                        <tr>
						  ...
						  <?php if($adminflag==1)
								  {
								   ?>
						   <td align=""><span style=""><form action="sp_major_items_input.php?ppt_id=<?php echo $pdData['ppt_id'] ?>" method="post" class="text-center">
						   <button type="submit" name="edit" id="edit" value="Edit" class="btn btn-outline-primary btn-fw px-1  py-1 " style="margin-top: 0; margin-bottom: 0; "> Edit </button></form></span>
						   <!--<span style="float:right"><form action="sp_major_items.php?ppt_id=<?php //echo $pdData['ppt_id'] ?>" method="post"><button type="submit" name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" class="btn btn-outline-danger btn-fw px-1  py-1 " style="margin-top: 0; margin-bottom: 0; "> Delete</button></form></span>--></td>
						   <?php
						   }
						   ?>
                        </tr>
