...
{
$sql_pro=mysqli_query($db, "INSERT INTO t023project_progress_graph (pid, planned, actual, ppg_date) Values(".$pid.",".$planned.", ".$actual.", '".$ppg_date."')");
	if ($sql_pro == TRUE) {
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Project Progress </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_progress_graph_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
                    ...
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            ...
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text" name="ppg_date" id="ppg_date" value="<?php echo $ppg_date_f; ?>" />
                            <p>yyyy-mm</p>
                            </div>
                          </div>
                        </div>
            ...
            <div class="row ">
                       <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Planned : </label>
                            <div class="col-sm-8 text-start">
                            <input placeholder="" class=" form-control bg-light text-dark "  type="text"  name="planned" id="planned" value="<?php echo $planned; ?>"  />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2"> </div>
            ...
            <div class="row pb-5 ">
                       <div class="col-md-1"></div>
                        <div class="col-md-9  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Actual : </label>
                            <div class="col-sm-8 text-start">
