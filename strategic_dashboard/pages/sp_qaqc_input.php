...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t0261qaqc (pid, serial, type, description, test, comp1, comp2, total) Values(".$pid.",".$serial.", '".$type."','".$description."','".$test."', ".$comp1.", ".$comp2.", ".$total.")");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_qaqc_input.php" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
          ...
          <div class="row  pt-4">
                        ...
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Type (QA/QC) : </label>
                            <div class="col-sm-8 text-start">
            ...
            <div class="row  ">
                        ...
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Test : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="test" id="test" value="<?php echo $test; ?>"  />
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  pb-5">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Total : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text"   name="total" id="total" value="<?php echo $total; ?>" />
                            </div>
                          </div>
                        </div>       
