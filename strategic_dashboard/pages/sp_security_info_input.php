...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysqli_query($db, "INSERT INTO t028security (pid, s_no, s_title, s_detail, s_status, s_action, s_remarks) Values(".$pid.",'".$s_no."', '".$s_title."', '".$s_detail."', '".$s_status."', '".$s_action."', '".$s_remarks."')");
	if ($sql_pro == TRUE) {
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="sp_security_info_input.php" target="_self" method="post" class=" col-sm-8" >
          ...
          <div class="row pt-4 ">
                       <div class="col-md-6  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Security Item No : </label>
                            <div class="col-sm-8 text-start">
                            <input class=" form-control bg-light text-dark "   type="text" name="s_no" id="s_no" value="<?php echo $s_no; ?>"   />
                            </div>
                          </div>
                        </div>       
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="s_title"><?php echo $s_title; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  ">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="s_detail"><?php echo $s_detail; ?> </textarea>
                            </div>
                          </div>
                        </div>     
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; "  name="s_status"><?php echo $s_status; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="row  pb-5">
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="s_action"><?php echo $s_action; ?> </textarea>
                            </div>
                          </div>
                        </div>  
                        <div class="col-md-6  ">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control bg-light text-dark " rows="4" style=" height: 100px; " name="s_remarks"><?php echo $s_remarks; ?> </textarea>
                            </div>
                          </div>
                        </div>
            </div>
