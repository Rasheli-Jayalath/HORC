...
<?php if($adminflag==1 && $sql_num==0)
								  {
								   ?>
		<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_typx_input.php';" > Add New Record </button>						   
 <?php
  }
  else if($adminflag==1 && $sql_num>=1)
  {?>
  <button type="button" class="col-sm-2 button-33" onclick="location.href='sp_typx_input.php?xsid=<?php echo $pdData['xsid']; ?>' " > Add New Record </button>
 <?php }
  ?>
