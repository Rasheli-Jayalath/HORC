...
<button type="button" class="col-sm-2 button-33" onclick="location.href='sp_video_input.php';" > Manage Videos </button>
<?php } 
     ...
     if( $pdSQLResult ->num_rows>= 1){
       ...
       if($cm==0 || $cm%6==0)
       {
        echo "<div class=\" text-center \" >";
                         ...
                         <span width="26%" ><?php if($result['al_file']!="")
       {
       ...
       ?>
        <a href="sp_video_large.php?video=<?php echo $result['al_file'];?>&phid=<?php echo $result['phid'];?>" target="_parent" >
                <img src="video_file_icon.jpg"   class="col-3" width="" height="" border="0" /></a>
       <?php
       //}
       //else
       //{
