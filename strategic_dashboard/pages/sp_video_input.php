...
@unlink($al_file.$al_file);
 mysqli_query($db, "Delete from t027project_videos where phid=".$_REQUEST['phid']);
...
{ 
 ...
 $extension = pathinfo($_FILES['al_file']['name'], PATHINFO_EXTENSION);
	...
	{
	$sql_pro=mysqli_query($db, "INSERT INTO t027project_videos(pid, al_file,ph_cap) Values(".$pid.", '".$file_name."', '".$ph_cap."' )");
	if ($sql_pro == TRUE) {
...
<!-- Page content  -->
<h4 class="text-center text-33" style="  letter-spacing: 4px ; font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"> Videos </h4> 
...
<div class=" col-sm-2" > </div>
  <form id="inputForm"  action="" target="_self" method="post" class=" col-sm-8" >
  ...
  <div class=" grid-margin stretch-card pt-4" >
                    ...
                    <div class="col-md-1"></div>
                        <div class="col-md-9 ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Video Caption : </label>
            ...
            <div class="row pb-5 ">
                       <div class="col-md-1"></div>
                        <div class="col-md-9  ">
                          <div class="form-group row">
                            <label class="col-sm-4 text-end pt-1" style="font-weight: 500; font-size: 14px;  ">  Video : </label>
                            <div class="col-sm-8 text-start">
...
<div style="" class="table-responsive bg-light">
  <table width="100%" class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <td  class="py-2"  align="left">  <img src="video_file_icon.jpg"  width="50" height="50"/></td>
                       
						  <?php if($adminflag==1)
								  {
								   ?>
						   <td  class="py-2"  align="right"><span style="float:left"><form action="sp_video_input.php?phid=<?php echo $pdData['phid'] ?>" method="post">
              ...
              </form></span><span style="float:right"><form action="sp_video_input.php?phid=<?php echo $pdData['phid'] ?>" method="post">
